...
<header class="masthead">
    <div class="container-fluid h-100">
        <div class="row h-100 align-items-center justify-content-center text-center">
            <div class="col-lg-8 align-self-end mb-4 page-title">
                <h3 class="text-white">Job Opportunity</h3>
                <hr class="divider my-4" />
            <div class="row col-md-12 mb-2 justify-content-center">
                    <button class="btn btn-success btn-block col-sm-4" type="button" id="new_career"><i class="fa fa-plus"></i> Post a Job Opportunity</button>
            </div>   
            </div>
    ...
    <div class="box-container">
     <div class="d-flex justify-content-center h-100">
         <div class="search"> <input class="search_input" id="filter" type="text" name="" placeholder="Find Forum etc."> <a id="search" class="search_icon box-a"><i class="fa fa-search"></i></a> </div>
     </div>
 </div>
<!-- <div class="container mt-3 pt-2">
   ...
   <?php
    ...
    <div class="card job-list" data-id="<?php echo $row['id'] ?>">
        <div class="card-body">
            <div class="row-card  align-items-center justify-content-center text-center h-100">
                <div class="">
                    ...
                    <button class="btn btn-danger float-right read_more" data-id="<?php echo $row['id'] ?>">Read More</button>
                </div>
            </div>
