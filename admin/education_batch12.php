				...
				<div class="card">
					...
					<div class="card-body">
							...
							<div class="form-group">
								...
								<input type="text" name="education_batch12_name" class="form-control" required>
							</div>
                            <div class="form-group">
								<label class="control-label">Registration No:</label>
								<input type="text" name="education_batch12_reg" class="form-control" required>
							</div>
                            <div class="form-group">
								<label class="control-label">Current Designation</label>
								<input type="text" name="education_batch12_desgination" class="form-control" required>
							</div>
					...
					<div class="card-body">
						<table class="table table-bordered table-hover">
                            ...
                            <?php
                                ...
                                $education_batch12_id = "";
                                $education_batch12_name = "";
                                $education_batch12_reg ="";
                                $education_batch12_desgination ="";
                                $query = "select * from education_batch12 ";
                                $query_run = mysqli_query($connection,$query);
                                while($row = mysqli_fetch_assoc($query_run)){
                                $education_batch12_id = $row['education_batch12_id'];
                                $education_batch12_name = $row['education_batch12_name'];
                                $education_batch12_reg = $row['education_batch12_reg'];
                                $education_batch12_desgination = $row['education_batch12_desgination'];

                             
                                ?>
								<tr>
									<td class="text-center">
                                    <?php echo $education_batch12_id ?>
                                    </td>
									<td class="">
										<?php echo $education_batch12_name?>
									</td>
                                    <td class="">
										<?php echo $education_batch12_reg?>
									</td>
                                    <td class="">
										<?php echo $education_batch12_desgination?>
									</td>
...
<script>
  ...
  <?php
	if(isset($_POST['add'])){
        ...
        $query = "insert into education_batch12 values(null,'$_POST[education_batch12_name]','$_POST[education_batch12_reg]','$_POST[education_batch12_desgination]')";
        $query_run = mysqli_query($connection,$query);
        echo "<script>location.href='education_batch12.php'</script>";
        }
  ?>
