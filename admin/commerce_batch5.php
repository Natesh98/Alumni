				...
				<div class="card">
					...
					<div class="card-body">
							...
							<div class="form-group">
								...
								<input type="text" name="commerce_batch5_name" class="form-control" required>
							</div>
                            <div class="form-group">
								<label class="control-label">Registration No:</label>
								<input type="text" name="commerce_batch5_reg" class="form-control" required>
							</div>
                            <div class="form-group">
								<label class="control-label">Current Designation</label>
								<input type="text" name="commerce_batch5_desgination" class="form-control" required>
							</div>
					...
					<div class="card-body">
						<table class="table table-bordered table-hover">
                            ...
                            <?php
                                ...
                                $commerce_batch5_id = "";
                                $commerce_batch5_name = "";
                                $commerce_batch5_reg ="";
                                $commerce_batch5_desgination ="";
                                $query = "select * from commerce_batch5 ";
                                $query_run = mysqli_query($connection,$query);
                                while($row = mysqli_fetch_assoc($query_run)){
                                $commerce_batch5_id = $row['commerce_batch5_id'];
                                $commerce_batch5_name = $row['commerce_batch5_name'];
                                $commerce_batch5_reg = $row['commerce_batch5_reg'];
                                $commerce_batch5_desgination = $row['commerce_batch5_desgination'];

                             
                                ?>
								<tr>
									<td class="text-center">
                                    <?php echo $commerce_batch5_id ?>
                                    </td>
									<td class="">
										<?php echo $commerce_batch5_name?>
									</td>
                                    <td class="">
										<?php echo $commerce_batch5_reg?>
									</td>
                                    <td class="">
										<?php echo $commerce_batch5_desgination?>
									</td>
...
<script>
  ...
  <?php
	if(isset($_POST['add'])){
        ...
        $query = "insert into commerce_batch5 values(null,'$_POST[commerce_batch5_name]','$_POST[commerce_batch5_reg]','$_POST[commerce_batch5_desgination]')";
        $query_run = mysqli_query($connection,$query);
        echo "<script>location.href='commerce_batch5.php'</script>";
        }
  ?>
