				...
				<div class="card">
					...
					<div class="card-body">
							...
							<div class="form-group">
								...
								<input type="text" name="education_batch5_name" class="form-control" required>
							</div>
                            <div class="form-group">
								<label class="control-label">Registration No:</label>
								<input type="text" name="education_batch5_reg" class="form-control" required>
							</div>
                            <div class="form-group">
								<label class="control-label">Current Designation</label>
								<input type="text" name="education_batch5_desgination" class="form-control" required>
							</div>
					...
					<div class="card-body">
						<table class="table table-bordered table-hover">
                            ...
                            <?php
                                ...
                                $education_batch5_id = "";
                                $education_batch5_name = "";
                                $education_batch5_reg ="";
                                $education_batch5_desgination ="";
                                $query = "select * from education_batch5 ";
                                $query_run = mysqli_query($connection,$query);
                                while($row = mysqli_fetch_assoc($query_run)){
                                $education_batch5_id = $row['education_batch5_id'];
                                $education_batch5_name = $row['education_batch5_name'];
                                $education_batch5_reg = $row['education_batch5_reg'];
                                $education_batch5_desgination = $row['education_batch5_desgination'];

                             
                                ?>
								<tr>
									<td class="text-center">
                                    <?php echo $education_batch5_id ?>
                                    </td>
									<td class="">
										<?php echo $education_batch5_name?>
									</td>
                                    <td class="">
										<?php echo $education_batch5_reg?>
									</td>
                                    <td class="">
										<?php echo $education_batch5_desgination?>
									</td>
...
<script>
  ...
  <?php
	if(isset($_POST['add'])){
        ...
        $query = "insert into education_batch5 values(null,'$_POST[education_batch5_name]','$_POST[education_batch5_reg]','$_POST[education_batch5_desgination]')";
        $query_run = mysqli_query($connection,$query);
        echo "<script>location.href='education_batch5.php'</script>";
        }
  ?>
