...
<body>
              ...
              <div class="card">
                ...
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" name="it_batch2_name" class="form-control" required>
                  </div>
                  <div class="form-group">
                    <label class="control-label">Registration No:</label>
                    <input type="text" name="it_batch2_reg" class="form-control" required>
                  </div>
                  <div class="form-group">
                    <label class="control-label">Current Desination</label>
                    <input type="text" name="it_batch2_desgination" class="form-control" required>
                  </div>
                  <div class="form-group">
                    <label class="control-label">Contact No:</label>
                    <input type="number" name="it_batch2_contact_no" class="form-control" maxlength="11" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" required>
                  </div>
                  <div class="form-group">
                    <label class="control-label">Email</label>
                    <input type="email" name="it_batch2_email" class="form-control" required>
                  </div>
                  <div class="form-group">
                    <label class="control-label">CNIC</label>
                    <input type="text" name="it_batch2_cnic" class="form-control"  maxlength="13" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" required>
                  </div>

                  <div class="form-group">
                    <label class="control-label">CGPA</label>
                    <input type="text" name="it_batch2_cgpa" class="form-control" required>
                  </div>
  ...
  if (isset($_POST['add'])) {
    ...
    $query = "insert into it_batch2 values(null,'$_POST[it_batch2_name]','$_POST[it_batch2_reg]','$_POST[it_batch2_desgination]', '$_POST[it_batch2_contact_no]', '$_POST[it_batch2_email]', '$_POST[it_batch2_cnic]', '$_POST[it_batch2_cgpa]')";
    $query_run = mysqli_query($connection, $query);
