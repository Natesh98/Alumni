				...
				<div class="card">
					...
					<div class="card-body">
							...
							<div class="form-group">
								...
								<input type="text" name="pharmacy_batch7_name" class="form-control" required>
							</div>
                            <div class="form-group">
								<label class="control-label">Registration No:</label>
								<input type="text" name="pharmacy_batch7_reg" class="form-control" required>
							</div>
                            <div class="form-group">
								<label class="control-label">Current Designation</label>
								<input type="text" name="pharmacy_batch7_desgination" class="form-control" required>
							</div>
					...
					<div class="card-body">
						<table class="table table-bordered table-hover">
                            ...
                            <?php
                                ...
                                $pharmacy_batch7_id = "";
                                $pharmacy_batch7_name = "";
                                $pharmacy_batch7_reg ="";
                                $pharmacy_batch7_desgination ="";
                                $query = "select * from pharmacy_batch7 ";
                                $query_run = mysqli_query($connection,$query);
                                while($row = mysqli_fetch_assoc($query_run)){
                                $pharmacy_batch7_id = $row['pharmacy_batch7_id'];
                                $pharmacy_batch7_name = $row['pharmacy_batch7_name'];
                                $pharmacy_batch7_reg = $row['pharmacy_batch7_reg'];
                                $pharmacy_batch7_desgination = $row['pharmacy_batch7_desgination'];

                             
                                ?>
								<tr>
									<td class="text-center">
                                    <?php echo $pharmacy_batch7_id ?>
                                    </td>
									<td class="">
										<?php echo $pharmacy_batch7_name?>
									</td>
                                    <td class="">
										<?php echo $pharmacy_batch7_reg?>
									</td>
                                    <td class="">
										<?php echo $pharmacy_batch7_desgination?>
									</td>
...
<script>
  ...
  <?php
	if(isset($_POST['add'])){
        ...
        $query = "insert into pharmacy_batch7 values(null,'$_POST[pharmacy_batch7_name]','$_POST[pharmacy_batch7_reg]','$_POST[pharmacy_batch7_desgination]')";
        $query_run = mysqli_query($connection,$query);
        echo "<script>location.href='pharmacy_batch7.php'</script>";
        }
  ?>
