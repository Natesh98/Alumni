				...
				<div class="card">
					...
					<div class="card-body">
							...
							<div class="form-group">
								...
								<input type="text" name="pharmacy_batch4_name" class="form-control" required>
							</div>
                            <div class="form-group">
								<label class="control-label">Registration No:</label>
								<input type="text" name="pharmacy_batch4_reg" class="form-control" required>
							</div>
                            <div class="form-group">
								<label class="control-label">Current Designation</label>
								<input type="text" name="pharmacy_batch4_desgination" class="form-control" required>
							</div>
					...
					<div class="card-body">
						<table class="table table-bordered table-hover">
                            ...
                            <?php
                                ...
                                $pharmacy_batch4_id = "";
                                $pharmacy_batch4_name = "";
                                $pharmacy_batch4_reg ="";
                                $pharmacy_batch4_desgination ="";
                                $query = "select * from pharmacy_batch4 ";
                                $query_run = mysqli_query($connection,$query);
                                while($row = mysqli_fetch_assoc($query_run)){
                                $pharmacy_batch4_id = $row['pharmacy_batch4_id'];
                                $pharmacy_batch4_name = $row['pharmacy_batch4_name'];
                                $pharmacy_batch4_reg = $row['pharmacy_batch4_reg'];
                                $pharmacy_batch4_desgination = $row['pharmacy_batch4_desgination'];

                             
                                ?>
								<tr>
									<td class="text-center">
                                    <?php echo $pharmacy_batch4_id ?>
                                    </td>
									<td class="">
										<?php echo $pharmacy_batch4_name?>
									</td>
                                    <td class="">
										<?php echo $pharmacy_batch4_reg?>
									</td>
                                    <td class="">
										<?php echo $pharmacy_batch4_desgination?>
									</td>
...
<script>
  ...
  <?php
	if(isset($_POST['add'])){
        ...
        $query = "insert into pharmacy_batch4 values(null,'$_POST[pharmacy_batch4_name]','$_POST[pharmacy_batch4_reg]','$_POST[pharmacy_batch4_desgination]')";
        $query_run = mysqli_query($connection,$query);
        echo "<script>location.href='pharmacy_batch4.php'</script>";
        }
  ?>
