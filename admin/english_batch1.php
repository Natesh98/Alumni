...
<meta content="" name="descriptison">
  ...
  <link href="https://fonts.googleapis.com/css?family=Open+Sans:300,300i,400,400i,600,600i,700,700i|Raleway:300,300i,400,400i,500,500i,600,600i,700,700i|Poppins:300,300i,400,400i,500,500i,600,600i,700,700i" rel="stylesheet">
    <link rel="stylesheet" href="assets/font-awesome/englishs/all.min.englishs">


  <!-- Vendor englishS Files -->
				...
				<div class="card">
					...
					<div class="card-body">
							...
							<div class="form-group">
								...
								<input type="text" name="english_batch1_name" class="form-control" required>
							</div>
                            <div class="form-group">
								<label class="control-label">Registration No:</label>
								<input type="text" name="english_batch1_reg" class="form-control" required>
							</div>
                            <div class="form-group">
								<label class="control-label">Current Designation</label>
								<input type="text" name="english_batch1_desgination" class="form-control" required>
							</div>
					...
					<div class="card-body">
						<table class="table table-bordered table-hover">
                            ...
                            <?php
                                ...
                                $english_batch1_name = "";
                                $english_batch1_reg ="";
                                $english_batch1_desgination ="";
                                $query = "select * from english_batch1 ";
                                $query_run = mysqli_query($connection,$query);
                                while($row = mysqli_fetch_assoc($query_run)){
                                $english_batch1_id = $row['english_batch1_id'];
                                $english_batch1_name = $row['english_batch1_name'];
                                $english_batch1_reg = $row['english_batch1_reg'];
                                $english_batch1_desgination = $row['english_batch1_desgination'];

                             
                                ?>
								<tr>
									<td class="text-center">
                                    <?php echo $english_batch1_id ?>
                                    </td>
									<td class="">
										<?php echo $english_batch1_name?>
									</td>
                                    <td class="">
										<?php echo $english_batch1_reg?>
									</td>
                                    <td class="">
										<?php echo $english_batch1_desgination?>
									</td>
...
<script>
  ...
  <?php
	if(isset($_POST['add'])){
        ...
        $query = "insert into english_batch1 values(null,'$_POST[english_batch1_name]','$_POST[english_batch1_reg]','$_POST[english_batch1_desgination]')";
        $query_run = mysqli_query($connection,$query);
        echo "<script>location.href='english_batch1.php'</script>";
