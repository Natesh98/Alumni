				...
				<div class="card">
					...
					<div class="card-body">
							...
							<div class="form-group">
								...
								<input type="text" name="commerce_batch1_name" class="form-control" required>
							</div>
                            <div class="form-group">
								<label class="control-label">Registration No:</label>
								<input type="text" name="commerce_batch1_reg" class="form-control" required>
							</div>
                            <div class="form-group">
								<label class="control-label">Current Designation</label>
								<input type="text" name="commerce_batch1_desgination" class="form-control" required>
							</div>
					...
					<div class="card-body">
						<table class="table table-bordered table-hover">
                            ...
                            <?php
                                ...
                                $commerce_batch1_id = "";
                                $commerce_batch1_name = "";
                                $commerce_batch1_reg ="";
                                $commerce_batch1_desgination ="";
                                $query = "select * from commerce_batch1 ";
                                $query_run = mysqli_query($connection,$query);
                                while($row = mysqli_fetch_assoc($query_run)){
                                $commerce_batch1_id = $row['commerce_batch1_id'];
                                $commerce_batch1_name = $row['commerce_batch1_name'];
                                $commerce_batch1_reg = $row['commerce_batch1_reg'];
                                $commerce_batch1_desgination = $row['commerce_batch1_desgination'];

                             
                                ?>
								<tr>
									<td class="text-center">
                                    <?php echo $commerce_batch1_id ?>
                                    </td>
									<td class="">
										<?php echo $commerce_batch1_name?>
									</td>
                                    <td class="">
										<?php echo $commerce_batch1_reg?>
									</td>
                                    <td class="">
										<?php echo $commerce_batch1_desgination?>
									</td>
...
<script>
  ...
  <?php
	if(isset($_POST['add'])){
        ...
        $query = "insert into commerce_batch1 values(null,'$_POST[commerce_batch1_name]','$_POST[commerce_batch1_reg]','$_POST[commerce_batch1_desgination]')";
        $query_run = mysqli_query($connection,$query);
        echo "<script>location.href='commerce_batch1.php'</script>";
        }
  ?>
