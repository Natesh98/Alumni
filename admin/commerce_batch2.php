...
<meta content="" name="descriptison">
  ...
  <link href="https://fonts.googleapis.com/css?family=Open+Sans:300,300i,400,400i,600,600i,700,700i|Raleway:300,300i,400,400i,500,500i,600,600i,700,700i|Poppins:300,300i,400,400i,500,500i,600,600i,700,700i" rel="stylesheet">
    <link rel="stylesheet" href="assets/font-awesome/commerces/all.min.css">
				...
				<div class="card">
					...
					<div class="card-body">
							...
							<div class="form-group">
								...
								<input type="text" name="commerce_batch2_name" class="form-control" required>
							</div>
                            <div class="form-group">
								<label class="control-label">Registration No:</label>
								<input type="text" name="commerce_batch2_reg" class="form-control" required>
							</div>
                            <div class="form-group">
								<label class="control-label">Current Designation</label>
								<input type="text" name="commerce_batch2_desgination" class="form-control" required>
							</div>
					...
					<div class="card-body">
						<table class="table table-bordered table-hover">
                            ...
                            <?php
                                ...
                                $commerce_batch2_id = "";
                                $commerce_batch2_name = "";
                                $commerce_batch2_reg ="";
                                $commerce_batch2_desgination ="";
                                $query = "select * from commerce_batch2 ";
                                $query_run = mysqli_query($connection,$query);
                                while($row = mysqli_fetch_assoc($query_run)){
                                $commerce_batch2_id = $row['commerce_batch2_id'];
                                $commerce_batch2_name = $row['commerce_batch2_name'];
                                $commerce_batch2_reg = $row['commerce_batch2_reg'];
                                $commerce_batch2_desgination = $row['commerce_batch2_desgination'];

                             
                                ?>
								<tr>
									<td class="text-center">
                                    <?php echo $commerce_batch2_id ?>
                                    </td>
									<td class="">
										<?php echo $commerce_batch2_name?>
									</td>
                                    <td class="">
										<?php echo $commerce_batch2_reg?>
									</td>
                                    <td class="">
										<?php echo $commerce_batch2_desgination?>
									</td>
...
<script>
  ...
  <?php
	if(isset($_POST['add'])){
        ...
        $query = "insert into commerce_batch2 values(null,'$_POST[commerce_batch2_name]','$_POST[commerce_batch2_reg]','$_POST[commerce_batch2_desgination]')";
        $query_run = mysqli_query($connection,$query);
        echo "<script>location.href='commerce_batch2.php'</script>";
        }
  ?>
