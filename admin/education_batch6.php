				...
				<div class="card">
					...
					<div class="card-body">
							...
							<div class="form-group">
								...
								<input type="text" name="education_batch6_name" class="form-control" required>
							</div>
                            <div class="form-group">
								<label class="control-label">Registration No:</label>
								<input type="text" name="education_batch6_reg" class="form-control" required>
							</div>
                            <div class="form-group">
								<label class="control-label">Current Designation</label>
								<input type="text" name="education_batch6_desgination" class="form-control" required>
							</div>
					...
					<div class="card-body">
						<table class="table table-bordered table-hover">
                            ...
                            <?php
                                ...
                                $education_batch6_id = "";
                                $education_batch6_name = "";
                                $education_batch6_reg ="";
                                $education_batch6_desgination ="";
                                $query = "select * from education_batch6 ";
                                $query_run = mysqli_query($connection,$query);
                                while($row = mysqli_fetch_assoc($query_run)){
                                $education_batch6_id = $row['education_batch6_id'];
                                $education_batch6_name = $row['education_batch6_name'];
                                $education_batch6_reg = $row['education_batch6_reg'];
                                $education_batch6_desgination = $row['education_batch6_desgination'];

                             
                                ?>
								<tr>
									<td class="text-center">
                                    <?php echo $education_batch6_id ?>
                                    </td>
									<td class="">
										<?php echo $education_batch6_name?>
									</td>
                                    <td class="">
										<?php echo $education_batch6_reg?>
									</td>
                                    <td class="">
										<?php echo $education_batch6_desgination?>
									</td>
...
<script>
  ...
  <?php
	if(isset($_POST['add'])){
        ...
        $query = "insert into education_batch6 values(null,'$_POST[education_batch6_name]','$_POST[education_batch6_reg]','$_POST[education_batch6_desgination]')";
        $query_run = mysqli_query($connection,$query);
        echo "<script>location.href='education_batch6.php'</script>";
        }
  ?>
