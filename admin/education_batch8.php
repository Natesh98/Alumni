				...
				<div class="card">
					...
					<div class="card-body">
							...
							<div class="form-group">
								...
								<input type="text" name="education_batch8_name" class="form-control" required>
							</div>
                            <div class="form-group">
								<label class="control-label">Registration No:</label>
								<input type="text" name="education_batch8_reg" class="form-control" required>
							</div>
                            <div class="form-group">
								<label class="control-label">Current Designation</label>
								<input type="text" name="education_batch8_desgination" class="form-control" required>
							</div>
					...
					<div class="card-body">
						<table class="table table-bordered table-hover">
                            ...
                            <?php
                                ...
                                $education_batch8_id = "";
                                $education_batch8_name = "";
                                $education_batch8_reg ="";
                                $education_batch8_desgination ="";
                                $query = "select * from education_batch8 ";
                                $query_run = mysqli_query($connection,$query);
                                while($row = mysqli_fetch_assoc($query_run)){
                                $education_batch8_id = $row['education_batch8_id'];
                                $education_batch8_name = $row['education_batch8_name'];
                                $education_batch8_reg = $row['education_batch8_reg'];
                                $education_batch8_desgination = $row['education_batch8_desgination'];

                             
                                ?>
								<tr>
									<td class="text-center">
                                    <?php echo $education_batch8_id ?>
                                    </td>
									<td class="">
										<?php echo $education_batch8_name?>
									</td>
                                    <td class="">
										<?php echo $education_batch8_reg?>
									</td>
                                    <td class="">
										<?php echo $education_batch8_desgination?>
									</td>
...
<script>
  ...
  <?php
	if(isset($_POST['add'])){
        ...
        $query = "insert into education_batch8 values(null,'$_POST[education_batch8_name]','$_POST[education_batch8_reg]','$_POST[education_batch8_desgination]')";
        $query_run = mysqli_query($connection,$query);
        echo "<script>location.href='education_batch8.php'</script>";
        }
  ?>
