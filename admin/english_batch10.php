				...
				<div class="card">
					...
					<div class="card-body">
							...
							<div class="form-group">
								...
								<input type="text" name="english_batch10_name" class="form-control" required>
							</div>
                            <div class="form-group">
								<label class="control-label">Registration No:</label>
								<input type="text" name="english_batch10_reg" class="form-control" required>
							</div>
                            <div class="form-group">
								<label class="control-label">Current Designation</label>
								<input type="text" name="english_batch10_desgination" class="form-control" required>
							</div>
					...
					<div class="card-body">
						<table class="table table-bordered table-hover">
                            ...
                            <?php
                                ...
                                $english_batch10_id = "";
                                $english_batch10_name = "";
                                $english_batch10_reg ="";
                                $english_batch10_desgination ="";
                                $query = "select * from english_batch10 ";
                                $query_run = mysqli_query($connection,$query);
                                while($row = mysqli_fetch_assoc($query_run)){
                                $english_batch10_id = $row['english_batch10_id'];
                                $english_batch10_name = $row['english_batch10_name'];
                                $english_batch10_reg = $row['english_batch10_reg'];
                                $english_batch10_desgination = $row['english_batch10_desgination'];

                             
                                ?>
								<tr>
									<td class="text-center">
                                    <?php echo $english_batch10_id ?>
                                    </td>
									<td class="">
										<?php echo $english_batch10_name?>
									</td>
                                    <td class="">
										<?php echo $english_batch10_reg?>
									</td>
                                    <td class="">
										<?php echo $english_batch10_desgination?>
									</td>
...
<script>
  ...
  <?php
	if(isset($_POST['add'])){
        ...
        $query = "insert into english_batch10 values(null,'$_POST[english_batch10_name]','$_POST[english_batch10_reg]','$_POST[english_batch10_desgination]')";
        $query_run = mysqli_query($connection,$query);
        echo "<script>location.href='english_batch10.php'</script>";
        }
  ?>
