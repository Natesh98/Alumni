...
<body>
              ...
              <div class="card">
                ...
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" name="it_batch9_name" class="form-control" required>
                  </div>
                  <div class="form-group">
                    <label class="control-label">Registration No:</label>
                    <input type="text" name="it_batch9_reg" class="form-control" required>
                  </div>
                  <div class="form-group">
                    <label class="control-label">Current Desination</label>
                    <input type="text" name="it_batch9_desgination" class="form-control" required>
                  </div>
                  <div class="form-group">
                    <label class="control-label">Contact No:</label>
                    <input type="number" name="it_batch9_contact_no" class="form-control" maxlength="11" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" required>
                  </div>
                  <div class="form-group">
                    <label class="control-label">Email</label>
                    <input type="email" name="it_batch9_email" class="form-control" required>
                  </div>
                  <div class="form-group">
                    <label class="control-label">CNIC</label>
                    <input type="text" name="it_batch9_cnic" class="form-control"  maxlength="13" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" required>
                  </div>

                  <div class="form-group">
                    <label class="control-label">CGPA</label>
                    <input type="text" name="it_batch9_cgpa" class="form-control" required>
                  </div>
  ...
  if (isset($_POST['add'])) {
    ...
    $query = "insert into it_batch9 values(null,'$_POST[it_batch9_name]','$_POST[it_batch9_reg]','$_POST[it_batch9_desgination]', '$_POST[it_batch9_contact_no]', '$_POST[it_batch9_email]', '$_POST[it_batch9_cnic]', '$_POST[it_batch9_cgpa]')";
    $query_run = mysqli_query($connection, $query);
    echo "<script>location.href='it_batch9.php'</script>";
  }
  ?>
