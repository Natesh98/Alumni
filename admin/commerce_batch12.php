				...
				<div class="card">
					...
					<div class="card-body">
							...
							<div class="form-group">
								...
								<input type="text" name="commerce_batch12_name" class="form-control" required>
							</div>
                            <div class="form-group">
								<label class="control-label">Registration No:</label>
								<input type="text" name="commerce_batch12_reg" class="form-control" required>
							</div>
                            <div class="form-group">
								<label class="control-label">Current Designation</label>
								<input type="text" name="commerce_batch12_desgination" class="form-control" required>
							</div>
					...
					<div class="card-body">
						<table class="table table-bordered table-hover">
                            ...
                            <?php
                                ...
                                $commerce_batch12_id = "";
                                $commerce_batch12_name = "";
                                $commerce_batch12_reg ="";
                                $commerce_batch12_desgination ="";
                                $query = "select * from commerce_batch12 ";
                                $query_run = mysqli_query($connection,$query);
                                while($row = mysqli_fetch_assoc($query_run)){
                                $commerce_batch12_id = $row['commerce_batch12_id'];
                                $commerce_batch12_name = $row['commerce_batch12_name'];
                                $commerce_batch12_reg = $row['commerce_batch12_reg'];
                                $commerce_batch12_desgination = $row['commerce_batch12_desgination'];

                             
                                ?>
								<tr>
									<td class="text-center">
                                    <?php echo $commerce_batch12_id ?>
                                    </td>
									<td class="">
										<?php echo $commerce_batch12_name?>
									</td>
                                    <td class="">
										<?php echo $commerce_batch12_reg?>
									</td>
                                    <td class="">
										<?php echo $commerce_batch12_desgination?>
									</td>
...
<script>
  ...
  <?php
	if(isset($_POST['add'])){
        ...
        $query = "insert into commerce_batch12 values(null,'$_POST[commerce_batch12_name]','$_POST[commerce_batch12_reg]','$_POST[commerce_batch12_desgination]')";
        $query_run = mysqli_query($connection,$query);
        echo "<script>location.href='commerce_batch12.php'</script>";
        }
  ?>
