				...
				<div class="card">
					...
					<div class="card-body">
							...
							<div class="form-group">
								...
								<input type="text" name="pharmacy_batch10_name" class="form-control" required>
							</div>
                            <div class="form-group">
								<label class="control-label">Registration No:</label>
								<input type="text" name="pharmacy_batch10_reg" class="form-control" required>
							</div>
                            <div class="form-group">
								<label class="control-label">Current Designation</label>
								<input type="text" name="pharmacy_batch10_desgination" class="form-control" required>
							</div>
					...
					<div class="card-body">
						<table class="table table-bordered table-hover">
                            ...
                            <?php
                                ...
                                $pharmacy_batch10_id = "";
                                $pharmacy_batch10_name = "";
                                $pharmacy_batch10_reg ="";
                                $pharmacy_batch10_desgination ="";
                                $query = "select * from pharmacy_batch10 ";
                                $query_run = mysqli_query($connection,$query);
                                while($row = mysqli_fetch_assoc($query_run)){
                                $pharmacy_batch10_id = $row['pharmacy_batch10_id'];
                                $pharmacy_batch10_name = $row['pharmacy_batch10_name'];
                                $pharmacy_batch10_reg = $row['pharmacy_batch10_reg'];
                                $pharmacy_batch10_desgination = $row['pharmacy_batch10_desgination'];

                             
                                ?>
								<tr>
									<td class="text-center">
                                    <?php echo $pharmacy_batch10_id ?>
                                    </td>
									<td class="">
										<?php echo $pharmacy_batch10_name?>
									</td>
                                    <td class="">
										<?php echo $pharmacy_batch10_reg?>
									</td>
                                    <td class="">
										<?php echo $pharmacy_batch10_desgination?>
									</td>
...
<script>
  ...
  <?php
	if(isset($_POST['add'])){
        ...
        $query = "insert into pharmacy_batch10 values(null,'$_POST[pharmacy_batch10_name]','$_POST[pharmacy_batch10_reg]','$_POST[pharmacy_batch10_desgination]')";
        $query_run = mysqli_query($connection,$query);
        echo "<script>location.href='pharmacy_batch10.php'</script>";
        }
  ?>
