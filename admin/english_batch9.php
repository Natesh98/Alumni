				...
				<div class="card">
					...
					<div class="card-body">
							...
							<div class="form-group">
								...
								<input type="text" name="english_batch9_name" class="form-control" required>
							</div>
                            <div class="form-group">
								<label class="control-label">Registration No:</label>
								<input type="text" name="english_batch9_reg" class="form-control" required>
							</div>
                            <div class="form-group">
								<label class="control-label">Current Designation</label>
								<input type="text" name="english_batch9_desgination" class="form-control" required>
							</div>
					...
					<div class="card-body">
						<table class="table table-bordered table-hover">
                            ...
                            <?php
                                ...
                                $english_batch9_name = "";
                                $english_batch9_reg ="";
                                $english_batch9_desgination ="";
                                $query = "select * from english_batch9 ";
                                $query_run = mysqli_query($connection,$query);
                                while($row = mysqli_fetch_assoc($query_run)){
                                $english_batch9_id = $row['english_batch9_id'];
                                $english_batch9_name = $row['english_batch9_name'];
                                $english_batch9_reg = $row['english_batch9_reg'];
                                $english_batch9_desgination = $row['english_batch9_desgination'];

                             
                                ?>
								<tr>
									<td class="text-center">
                                    <?php echo $english_batch9_id ?>
                                    </td>
									<td class="">
										<?php echo $english_batch9_name?>
									</td>
                                    <td class="">
										<?php echo $english_batch9_reg?>
									</td>
                                    <td class="">
										<?php echo $english_batch9_desgination?>
									</td>
...
<script>
  ...
  <?php
	if(isset($_POST['add'])){
        ...
        $query = "insert into english_batch9 values(null,'$_POST[english_batch9_name]','$_POST[english_batch9_reg]','$_POST[english_batch9_desgination]')";
        $query_run = mysqli_query($connection,$query);
        echo "<script>location.href='english_batch9.php'</script>";
        }
  ?>
