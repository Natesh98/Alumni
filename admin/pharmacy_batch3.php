...
<meta content="" name="descriptison">
  ...
  <link href="https://fonts.googleapis.com/css?family=Open+Sans:300,300i,400,400i,600,600i,700,700i|Raleway:300,300i,400,400i,500,500i,600,600i,700,700i|Poppins:300,300i,400,400i,500,500i,600,600i,700,700i" rel="stylesheet">
    <link rel="stylesheet" href="assets/font-awesome/pharmacys/all.min.pharmacys">
				...
				<div class="card">
					...
					<div class="card-body">
							...
							<div class="form-group">
								...
								<input type="text" name="pharmacy_batch3_name" class="form-control" required>
							</div>
                            <div class="form-group">
								<label class="control-label">Registration No:</label>
								<input type="text" name="pharmacy_batch3_reg" class="form-control" required>
							</div>
                            <div class="form-group">
								<label class="control-label">Current Designation</label>
								<input type="text" name="pharmacy_batch3_desgination" class="form-control" required>
							</div>
					...
					<div class="card-body">
						<table class="table table-bordered table-hover">
                            ...
                            <?php
                                ...
                                $pharmacy_batch3_id = "";
                                $pharmacy_batch3_name = "";
                                $pharmacy_batch3_reg ="";
                                $pharmacy_batch3_desgination ="";
                                $query = "select * from pharmacy_batch3 ";
                                $query_run = mysqli_query($connection,$query);
                                while($row = mysqli_fetch_assoc($query_run)){
                                $pharmacy_batch3_id = $row['pharmacy_batch3_id'];
                                $pharmacy_batch3_name = $row['pharmacy_batch3_name'];
                                $pharmacy_batch3_reg = $row['pharmacy_batch3_reg'];
                                $pharmacy_batch3_desgination = $row['pharmacy_batch3_desgination'];

                             
                                ?>
								<tr>
									<td class="text-center">
                                    <?php echo $pharmacy_batch3_id ?>
                                    </td>
									<td class="">
										<?php echo $pharmacy_batch3_name?>
									</td>
                                    <td class="">
										<?php echo $pharmacy_batch3_reg?>
									</td>
                                    <td class="">
										<?php echo $pharmacy_batch3_desgination?>
									</td>
...
<script>
  ...
  <?php
	if(isset($_POST['add'])){
        ...
        $query = "insert into pharmacy_batch3 values(null,'$_POST[pharmacy_batch3_name]','$_POST[pharmacy_batch3_reg]','$_POST[pharmacy_batch3_desgination]')";
        $query_run = mysqli_query($connection,$query);
        echo "<script>location.href='pharmacy_batch3.php'</script>";
        }
  ?>
