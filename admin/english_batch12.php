				...
				<div class="card">
					...
					<div class="card-body">
							...
							<div class="form-group">
								...
								<input type="text" name="english_batch12_name" class="form-control" required>
							</div>
                            <div class="form-group">
								<label class="control-label">Registration No:</label>
								<input type="text" name="english_batch12_reg" class="form-control" required>
							</div>
                            <div class="form-group">
								<label class="control-label">Current Designation</label>
								<input type="text" name="english_batch12_desgination" class="form-control" required>
							</div>
					...
					<div class="card-body">
						<table class="table table-bordered table-hover">
                            ...
                            <?php
                                ...
                                $english_batch12_id = "";
                                $english_batch12_name = "";
                                $english_batch12_reg ="";
                                $english_batch12_desgination ="";
                                $query = "select * from english_batch12 ";
                                $query_run = mysqli_query($connection,$query);
                                while($row = mysqli_fetch_assoc($query_run)){
                                $english_batch12_id = $row['english_batch12_id'];
                                $english_batch12_name = $row['english_batch12_name'];
                                $english_batch12_reg = $row['english_batch12_reg'];
                                $english_batch12_desgination = $row['english_batch12_desgination'];

                             
                                ?>
								<tr>
									<td class="text-center">
                                    <?php echo $english_batch12_id ?>
                                    </td>
									<td class="">
										<?php echo $english_batch12_name?>
									</td>
                                    <td class="">
										<?php echo $english_batch12_reg?>
									</td>
                                    <td class="">
										<?php echo $english_batch12_desgination?>
									</td>
...
<script>
  ...
  <?php
	if(isset($_POST['add'])){
        ...
        $query = "insert into english_batch12 values(null,'$_POST[english_batch12_name]','$_POST[english_batch12_reg]','$_POST[english_batch12_desgination]')";
        $query_run = mysqli_query($connection,$query);
        echo "<script>location.href='english_batch12.php'</script>";
        }
  ?>
