				...
				<div class="card">
					...
					<div class="card-body">
							...
							<div class="form-group">
								...
								<input type="text" name="commerce_batch8_name" class="form-control" required>
							</div>
                            <div class="form-group">
								<label class="control-label">Registration No:</label>
								<input type="text" name="commerce_batch8_reg" class="form-control" required>
							</div>
                            <div class="form-group">
								<label class="control-label">Current Designation</label>
								<input type="text" name="commerce_batch8_desgination" class="form-control" required>
							</div>
					...
					<div class="card-body">
						<table class="table table-bordered table-hover">
                            ...
                            <?php
                                ...
                                $commerce_batch8_id = "";
                                $commerce_batch8_name = "";
                                $commerce_batch8_reg ="";
                                $commerce_batch8_desgination ="";
                                $query = "select * from commerce_batch8 ";
                                $query_run = mysqli_query($connection,$query);
                                while($row = mysqli_fetch_assoc($query_run)){
                                $commerce_batch8_id = $row['commerce_batch8_id'];
                                $commerce_batch8_name = $row['commerce_batch8_name'];
                                $commerce_batch8_reg = $row['commerce_batch8_reg'];
                                $commerce_batch8_desgination = $row['commerce_batch8_desgination'];

                             
                                ?>
								<tr>
									<td class="text-center">
                                    <?php echo $commerce_batch8_id ?>
                                    </td>
									<td class="">
										<?php echo $commerce_batch8_name?>
									</td>
                                    <td class="">
										<?php echo $commerce_batch8_reg?>
									</td>
                                    <td class="">
										<?php echo $commerce_batch8_desgination?>
									</td>
...
<script>
  ...
  <?php
	if(isset($_POST['add'])){
        ...
        $query = "insert into commerce_batch8 values(null,'$_POST[commerce_batch8_name]','$_POST[commerce_batch8_reg]','$_POST[commerce_batch8_desgination]')";
        $query_run = mysqli_query($connection,$query);
        echo "<script>location.href='commerce_batch8.php'</script>";
        }
  ?>
