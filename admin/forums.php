				...
				<div class="card">
					<div class="card-header">
						...
						<span class="">
							...
							<button class="btn btn-success btn-block btn-sm col-sm-2 float-right" type="button" id="new_forum">
							...
							<tbody>
								...
								<tr>
									...
									<td class="text-center">
										<a class="btn btn-sm btn-outline-success view_forum" href="../index.php?page=view_forum&id=<?php echo $row['id'] ?>" target="_blank" data-id="<?php echo $row['id'] ?>" >View</a>
