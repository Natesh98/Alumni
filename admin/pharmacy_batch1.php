...
<meta content="" name="descriptison">
  ...
  <link href="https://fonts.googleapis.com/css?family=Open+Sans:300,300i,400,400i,600,600i,700,700i|Raleway:300,300i,400,400i,500,500i,600,600i,700,700i|Poppins:300,300i,400,400i,500,500i,600,600i,700,700i" rel="stylesheet">
    <link rel="stylesheet" href="assets/font-awesome/pharmacys/all.min.css">
				...
				<div class="card">
					...
					<div class="card-body">
							...
							<div class="form-group">
								...
								<input type="text" name="pharmacy_batch1_name" class="form-control" required>
							</div>
                            <div class="form-group">
								<label class="control-label">Registration No:</label>
								<input type="text" name="pharmacy_batch1_reg" class="form-control" required>
							</div>
                            <div class="form-group">
								<label class="control-label">Current Designation</label>
								<input type="text" name="pharmacy_batch1_desgination" class="form-control" required>
							</div>
					...
					<div class="card-body">
						<table class="table table-bordered table-hover">
                            ...
                            <?php
                                ...
                                $pharmacy_batch1_id = "";
                                $pharmacy_batch1_name = "";
                                $pharmacy_batch1_reg ="";
                                $pharmacy_batch1_desgination ="";
                                $query = "select * from pharmacy_batch1 ";
                                $query_run = mysqli_query($connection,$query);
                                while($row = mysqli_fetch_assoc($query_run)){
                                $pharmacy_batch1_id = $row['pharmacy_batch1_id'];
                                $pharmacy_batch1_name = $row['pharmacy_batch1_name'];
                                $pharmacy_batch1_reg = $row['pharmacy_batch1_reg'];
                                $pharmacy_batch1_desgination = $row['pharmacy_batch1_desgination'];

                             
                                ?>
								<tr>
									<td class="text-center">
                                    <?php echo $pharmacy_batch1_id ?>
                                    </td>
									<td class="">
										<?php echo $pharmacy_batch1_name?>
									</td>
                                    <td class="">
										<?php echo $pharmacy_batch1_reg?>
									</td>
                                    <td class="">
										<?php echo $pharmacy_batch1_desgination?>
									</td>
...
<script>
  ...
  <?php
	if(isset($_POST['add'])){
        ...
        $query = "insert into pharmacy_batch1 values(null,'$_POST[pharmacy_batch1_name]','$_POST[pharmacy_batch1_reg]','$_POST[pharmacy_batch1_desgination]')";
        $query_run = mysqli_query($connection,$query);
        echo "<script>location.href='pharmacy_batch1.php'</script>";
        }
  ?>
