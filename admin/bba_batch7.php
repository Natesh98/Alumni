...
<body>
              ...
              <div class="card">
                ...
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" name="bba_batch7_name" class="form-control" required>
                  </div>
                  <div class="form-group">
                    <label class="control-label">Registration No:</label>
                    <input type="text" name="bba_batch7_reg" class="form-control" required>
                  </div>
                  <div class="form-group">
                    <label class="control-label">Current Desination</label>
                    <input type="text" name="bba_batch7_desgination" class="form-control" required>
                  </div>
                  <div class="form-group">
                    <label class="control-label">Contact No:</label>
                    <input type="number" name="bba_batch7_contact_no" class="form-control" maxlength="11" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" required>
                  </div>
                  <div class="form-group">
                    <label class="control-label">Email</label>
                    <input type="email" name="bba_batch7_email" class="form-control" required>
                  </div>
                  <div class="form-group">
                    <label class="control-label">CNIC</label>
                    <input type="text" name="bba_batch7_cnic" class="form-control"  maxlength="13" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" required>
                  </div>

                  <div class="form-group">
                    <label class="control-label">CGPA</label>
                    <input type="text" name="bba_batch7_cgpa" class="form-control" required>
                  </div>
  ...
  if (isset($_POST['add'])) {
    ...
    $query = "insert into bba_batch7 values(null,'$_POST[bba_batch7_name]','$_POST[bba_batch7_reg]','$_POST[bba_batch7_desgination]', '$_POST[bba_batch7_contact_no]', '$_POST[bba_batch7_email]', '$_POST[bba_batch7_cnic]', '$_POST[bba_batch7_cgpa]')";
    $query_run = mysqli_query($connection, $query);
    echo "<script>location.href='bba_batch7.php'</script>";
  }
  ?>
