...
<meta content="" name="descriptison">
  ...
  <link href="https://fonts.googleapis.com/css?family=Open+Sans:300,300i,400,400i,600,600i,700,700i|Raleway:300,300i,400,400i,500,500i,600,600i,700,700i|Poppins:300,300i,400,400i,500,500i,600,600i,700,700i" rel="stylesheet">
    <link rel="stylesheet" href="assets/font-awesome/educations/all.min.css">
				...
				<div class="card">
					...
					<div class="card-body">
							...
							<div class="form-group">
								...
								<input type="text" name="education_batch2_name" class="form-control" required>
							</div>
                            <div class="form-group">
								<label class="control-label">Registration No:</label>
								<input type="text" name="education_batch2_reg" class="form-control" required>
							</div>
                            <div class="form-group">
								<label class="control-label">Current Designation</label>
								<input type="text" name="education_batch2_desgination" class="form-control" required>
							</div>
					...
					<div class="card-body">
						<table class="table table-bordered table-hover">
                            ...
                            <?php
                                ...
                                $education_batch2_id = "";
                                $education_batch2_name = "";
                                $education_batch2_reg ="";
                                $education_batch2_desgination ="";
                                $query = "select * from education_batch2 ";
                                $query_run = mysqli_query($connection,$query);
                                while($row = mysqli_fetch_assoc($query_run)){
                                $education_batch2_id = $row['education_batch2_id'];
                                $education_batch2_name = $row['education_batch2_name'];
                                $education_batch2_reg = $row['education_batch2_reg'];
                                $education_batch2_desgination = $row['education_batch2_desgination'];

                             
                                ?>
								<tr>
									<td class="text-center">
                                    <?php echo $education_batch2_id ?>
                                    </td>
									<td class="">
										<?php echo $education_batch2_name?>
									</td>
                                    <td class="">
										<?php echo $education_batch2_reg?>
									</td>
                                    <td class="">
										<?php echo $education_batch2_desgination?>
									</td>
...
<script>
  ...
  <?php
	if(isset($_POST['add'])){
        ...
        $query = "insert into education_batch2 values(null,'$_POST[education_batch2_name]','$_POST[education_batch2_reg]','$_POST[education_batch2_desgination]')";
        $query_run = mysqli_query($connection,$query);
        echo "<script>location.href='education_batch2.php'</script>";
        }
  ?>
