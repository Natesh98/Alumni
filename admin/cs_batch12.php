...
<body>
              ...
              <div class="card">
                ...
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" name="cs_batch12_name" class="form-control" required>
                  </div>
                  <div class="form-group">
                    <label class="control-label">Registration No:</label>
                    <input type="text" name="cs_batch12_reg" class="form-control" required>
                  </div>
                  <div class="form-group">
                    <label class="control-label">Current Designation</label>
                    <input type="text" name="cs_batch12_desgination" class="form-control" required>
                  </div>
                  <div class="form-group">
                    <label class="control-label">Contact No.</label>
                    <input type="number" name="cs_batch12_contact_no" class="form-control" maxlength="11" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" required>
                  </div>
                  <div class="form-group">
                    <label class="control-label">Email</label>
                    <input type="email" name="cs_batch12_email" class="form-control" required>
                  </div>
                  <div class="form-group">
                    <label class="control-label">CGPA</label>
                    <input type="text" name="cs_batch12_cgpa" class="form-control" required>
                  </div>
  ...
  if (isset($_POST['add'])) {
    ...
    $query = "insert into cs_batch12 values(null,'$_POST[cs_batch12_name]','$_POST[cs_batch12_reg]','$_POST[cs_batch12_desgination]', '$_POST[cs_batch12_contact_no]', '$_POST[cs_batch12_email]', '$_POST[cs_batch12_cgpa]')";
    $query_run = mysqli_query($connection, $query);
    echo "<script>location.href='cs_batch12.php'</script>";
  }
  ?>
