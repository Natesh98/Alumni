				...
				<div class="card">
					...
					<div class="card-body">
							...
							<div class="form-group">
								...
								<input type="text" name="pharmacy_batch11_name" class="form-control" required>
							</div>
                            <div class="form-group">
								<label class="control-label">Registration No:</label>
								<input type="text" name="pharmacy_batch11_reg" class="form-control" required>
							</div>
                            <div class="form-group">
								<label class="control-label">Current Designation</label>
								<input type="text" name="pharmacy_batch11_desgination" class="form-control" required>
							</div>
					...
					<div class="card-body">
						<table class="table table-bordered table-hover">
                            ...
                            <?php
                                ...
                                $pharmacy_batch11_id = "";
                                $pharmacy_batch11_name = "";
                                $pharmacy_batch11_reg ="";
                                $pharmacy_batch11_desgination ="";
                                $query = "select * from pharmacy_batch11 ";
                                $query_run = mysqli_query($connection,$query);
                                while($row = mysqli_fetch_assoc($query_run)){
                                $pharmacy_batch11_id = $row['pharmacy_batch11_id'];
                                $pharmacy_batch11_name = $row['pharmacy_batch11_name'];
                                $pharmacy_batch11_reg = $row['pharmacy_batch11_reg'];
                                $pharmacy_batch11_desgination = $row['pharmacy_batch11_desgination'];

                             
                                ?>
								<tr>
									<td class="text-center">
                                    <?php echo $pharmacy_batch11_id ?>
                                    </td>
									<td class="">
										<?php echo $pharmacy_batch11_name?>
									</td>
                                    <td class="">
										<?php echo $pharmacy_batch11_reg?>
									</td>
                                    <td class="">
										<?php echo $pharmacy_batch11_desgination?>
									</td>
...
<script>
  ...
  <?php
	if(isset($_POST['add'])){
        ...
        $query = "insert into pharmacy_batch11 values(null,'$_POST[pharmacy_batch11_name]','$_POST[pharmacy_batch11_reg]','$_POST[pharmacy_batch11_desgination]')";
        $query_run = mysqli_query($connection,$query);
        echo "<script>location.href='pharmacy_batch11.php'</script>";
        }
  ?>
