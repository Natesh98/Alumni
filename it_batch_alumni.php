                            ...
                            <tbody>
                                ...
                                ?>
                                        <tr>
                                            <td class="text-center">
                                                <?php echo $it_batch1_id ?>
                                            </td>
                                            <td class="">
                                                <?php echo $it_batch1_name ?>
                                            </td>
                                            <td class="">
                                                <?php echo $it_batch1_reg ?>
                                            </td>
                                            <td class="">
                                                <?php echo $it_batch1_desgination ?>
                                            </td>
                                            <td class="">
                                                <?php echo $it_batch1_contact_no ?>
                                            </td>
                                            <td class="">
                                                <?php echo $it_batch1_email ?>
                                            </td>
                                            <td class="">
                                                <?php echo $it_batch1_cgpa ?>
                                            </td>
                                    ...
                                    ?>
                                        <tr>
                                            <td class="text-center">
                                                <?php echo $it_batch2_id ?>
                                            </td>
                                            <td class="">
                                                <?php echo $it_batch2_name ?>
                                            </td>
                                            <td class="">
                                                <?php echo $it_batch2_reg ?>
                                            </td>
                                            <td class="">
                                                <?php echo $it_batch2_desgination ?>
                                            </td>
                                            <td class="">
                                                <?php echo $it_batch2_contact_no ?>
                                            </td>
                                            <td class="">
                                                <?php echo $it_batch2_email ?>
                                            </td>
                                            <td class="">
                                                <?php echo $it_batch2_cgpa ?>
                                            </td>
                                ...
                                <?php
                                    ...
                                    ?>
                                        <tr>
                                            <td class="text-center">
                                                <?php echo $it_batch3_id ?>
                                            </td>
                                            <td class="">
                                                <?php echo $it_batch3_name ?>
                                            </td>
                                            <td class="">
                                                <?php echo $it_batch3_reg ?>
                                            </td>
                                            <td class="">
                                                <?php echo $it_batch3_desgination ?>
                                            </td>
                                            <td class="">
                                                <?php echo $it_batch3_contact_no ?>
                                            </td>
                                            <td class="">
                                                <?php echo $it_batch3_email ?>
                                            </td>
                                            <td class="">
                                                <?php echo $it_batch3_cgpa ?>
                                            </td>
                                ...
                                <?php
                                    ...
                                    ?>
                                        <tr>
                                            <td class="text-center">
                                                <?php echo $it_batch4_id ?>
                                            </td>
                                            <td class="">
                                                <?php echo $it_batch4_name ?>
                                            </td>
                                            <td class="">
                                                <?php echo $it_batch4_reg ?>
                                            </td>
                                            <td class="">
                                                <?php echo $it_batch4_desgination ?>
                                            </td>
                                            <td class="">
                                                <?php echo $it_batch4_contact_no ?>
                                            </td>
                                            <td class="">
                                                <?php echo $it_batch4_email ?>
                                            </td>
                                            <td class="">
                                                <?php echo $it_batch4_cgpa ?>
                                            </td>
                                ...
                                <?php
                                    ...
                                    ?>
                                        <tr>
                                            <td class="text-center">
                                                <?php echo $it_batch5_id ?>
                                            </td>
                                            <td class="">
                                                <?php echo $it_batch5_name ?>
                                            </td>
                                            <td class="">
                                                <?php echo $it_batch5_reg ?>
                                            </td>
                                            <td class="">
                                                <?php echo $it_batch5_desgination ?>
                                            </td>
                                            <td class="">
                                                <?php echo $it_batch5_contact_no ?>
                                            </td>
                                            <td class="">
                                                <?php echo $it_batch5_email ?>
                                            </td>
                                            <td class="">
                                                <?php echo $it_batch5_cgpa ?>
                                            </td>
                                ...
                                <?php
                                    ...
                                    ?>
                                        <tr>
                                            <td class="text-center">
                                                <?php echo $it_batch6_id ?>
                                            </td>
                                            <td class="">
                                                <?php echo $it_batch6_name ?>
                                            </td>
                                            <td class="">
                                                <?php echo $it_batch6_reg ?>
                                            </td>
                                            <td class="">
                                                <?php echo $it_batch6_desgination ?>
                                            </td>
                                            <td class="">
                                                <?php echo $it_batch6_contact_no ?>
                                            </td>
                                            <td class="">
                                                <?php echo $it_batch6_email ?>
                                            </td>
                                            <td class="">
                                                <?php echo $it_batch6_cgpa ?>
                                            </td>
                                ...
                                <?php
                                    ...
                                    ?>
                                        <tr>
                                            <td class="text-center">
                                                <?php echo $it_batch8_id ?>
                                            </td>
                                            <td class="">
                                                <?php echo $it_batch8_name ?>
                                            </td>
                                            <td class="">
                                                <?php echo $it_batch8_reg ?>
                                            </td>
                                            <td class="">
                                                <?php echo $it_batch8_desgination ?>
                                            </td>
                                            <td class="">
                                                <?php echo $it_batch8_contact_no ?>
                                            </td>
                                            <td class="">
                                                <?php echo $it_batch8_email ?>
                                            </td>
                                            <td class="">
                                                <?php echo $it_batch8_cgpa ?>
                                            </td>
                                ...
                                <?php
                                    ...
                                    ?>
                                        <tr>
                                            <td class="text-center">
                                                <?php echo $it_batch9_id ?>
                                            </td>
                                            <td class="">
                                                <?php echo $it_batch9_name ?>
                                            </td>
                                            <td class="">
                                                <?php echo $it_batch9_reg ?>
                                            </td>
                                            <td class="">
                                                <?php echo $it_batch9_desgination ?>
                                            </td>
                                            <td class="">
                                                <?php echo $it_batch9_contact_no ?>
                                            </td>
                                            <td class="">
                                                <?php echo $it_batch9_email ?>
                                            </td>
                                            <td class="">
                                                <?php echo $it_batch9_cgpa ?>
                                            </td>
                                ...
                                <?php
                                    ...
                                    ?>
                                        <tr>
                                            <td class="text-center">
                                                <?php echo $it_batch10_id ?>
                                            </td>
                                            <td class="">
                                                <?php echo $it_batch10_name ?>
                                            </td>
                                            <td class="">
                                                <?php echo $it_batch10_reg ?>
                                            </td>
                                            <td class="">
                                                <?php echo $it_batch10_desgination ?>
                                            </td>
                                            <td class="">
                                                <?php echo $it_batch10_contact_no ?>
                                            </td>
                                            <td class="">
                                                <?php echo $it_batch10_email ?>
                                            </td>
                                            <td class="">
                                                <?php echo $it_batch10_cgpa ?>
                                            </td>
                                ...
                                <?php
                                    ...
                                    ?>
                                        <tr>
                                            <td class="text-center">
                                                <?php echo $it_batch11_id ?>
                                            </td>
                                            <td class="">
                                                <?php echo $it_batch11_name ?>
                                            </td>
                                            <td class="">
                                                <?php echo $it_batch11_reg ?>
                                            </td>
                                            <td class="">
                                                <?php echo $it_batch11_desgination ?>
                                            </td>
                                            <td class="">
                                                <?php echo $it_batch11_contact_no ?>
                                            </td>
                                            <td class="">
                                                <?php echo $it_batch11_email ?>
                                            </td>
                                            <td class="">
                                                <?php echo $it_batch2_cgpa ?>
                                            </td>
                                ...
                                <?php
                                    ...
                                    ?>
                                        <tr>
                                            <td class="text-center">
                                                <?php echo $it_batch12_id ?>
                                            </td>
                                            <td class="">
                                                <?php echo $it_batch12_name ?>
                                            </td>
                                            <td class="">
                                                <?php echo $it_batch12_reg ?>
                                            </td>
                                            <td class="">
                                                <?php echo $it_batch12_desgination ?>
                                            </td>
                                            <td class="">
                                                <?php echo $it_batch12_contact_no ?>
                                            </td>
                                            <td class="">
                                                <?php echo $it_batch12_email ?>
                                            </td>
                                            <td class="">
                                                <?php echo $it_batch12_cgpa ?>
                                            </td>
