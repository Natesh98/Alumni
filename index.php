                          ...
                          <div class=" dropdown">
                              <a href="#" class="nav-link js-scroll-trigger"  id="account_settings" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Department <i class="fa fa-angle-down"></i></a>
                                <div class="dropdown-menu" aria-labelledby="department" >
                                  ...
                                  <a class="dropdown-item" href="index.php?page=bba_dept" id="bba_dept">BBA Department</a>
                                  
                                </div>
                          </div>
                        </li>                        <li class="nav-item"><a class="nav-link js-scroll-trigger" href="index.php?page=gallery">Gallery</a></li>
            ...
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-lg-8 text-center">
                        <i><h2 class="mt-0 text-success">Further Detail Contact</h2></i>
